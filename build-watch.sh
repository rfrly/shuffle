...
watch_css = r"""
    ...
    .watch-active .exercise-number.stopwatch-time { font-size: clamp(4rem, 16vw, 7rem); }
      ...
      useEffect(() => {
        ...
        cmdsRef.on("value", snap => {
          ...
          if (cmd.mode != null) {
            ...
            setMode(cmd.mode);
            setInfinite(cmd.infinite != null ? !!cmd.infinite : cmd.mode === MODE_FULLSET || cmd.mode === MODE_SEQUENTIAL ? false : false);
            setStopwatch(cmd.stopwatch != null ? !!cmd.stopwatch : false);
          } else {
      ...
      return (
        ...
        {watchScreen === "home" && (
          <div className="watch-overlay">
            ...
            <div style={{ fontSize: "0.55rem", color: "#444", fontFamily: "var(--font-mono)", letterSpacing: "0.1em", marginTop: "0.5rem" }}>v1.9.7 · watch 1.35</div>
          </div>
        )}
        {watchScreen === "share" && (
          <div className="watch-overlay">

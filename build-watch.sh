        ...
        <div className="observer-app">
          ...
          {obsBpmAutoOpen && (isObsMetronome || obsInfiniteEff) && ReactDOM.createPortal(
            <BpmAutoPopup
              ...
              bpm={obsBpm || 80}
              bpmAuto={localBpmAuto} setBpmAuto={v => { setLocalBpmAuto(v); onSendCmd({ bpmAuto: v }); }}
              ...
              bpmAutoRandom={localBpmAutoRandom} setBpmAutoRandom={v => { setLocalBpmAutoRandom(v); onSendCmd({ bpmAutoRandom: v }); }}

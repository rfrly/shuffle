        ...
        <div className="observer-app">
          ...
          <div className="display">
            <div className="exercise-label">
              {isCountIn ? "count in" : sc ? "\u00A0" : isIdle ? "ready" : obsMode === "clickonly" ? "time" : "exercise"}
            </div>
      ...
      return (
        ...
        {watchScreen === "home" && (
          <div className="watch-overlay">
            ...
            <div style={{ fontSize: "0.55rem", color: "#444", fontFamily: "var(--font-mono)", letterSpacing: "0.1em", marginTop: "0.5rem" }}>v1.9.8 · watch 1.46</div>
          </div>
        )}
        {watchScreen === "share" && (
          <div className="watch-overlay">

...
### What it does
- Student opens `shuffleclick.com/watch/` → taps "Share my session" → gets a two-word code (e.g. `BIRD-BOAT`) → uses Shuffle normally; settings controls are dimmed and non-interactive while sharing
